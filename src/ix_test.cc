...
#define FEW_ENTRIES  999999
#define REPEAT_LENGTH 2
#define NENTRIES     1000000          // Size of values array
#define PROG_UNIT    200              // how frequently to give progress reports when adding lots of entries
...
void ranRepeat(int n);
RC InsertIntEntriesRepeat(IX_IndexHandle &ih, int nEntries);
RC InsertFloatEntriesRepeat(IX_IndexHandle &ih, int nEntries);
RC InsertStringEntriesRepeat(IX_IndexHandle &ih, int nEntries);
